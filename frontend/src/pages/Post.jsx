        ...
        <div className="flex flex-col gap-6 mx-16 bg-lightBlue-600 md:pt-32  pt-12">
          ...
          <div className="flex justify-center gap-4 items-center p-4">
            ...
            <input
              ...
              class="block border-2 mt-2 w-full placeholder-gray-400/70 dark:placeholder-gray-500 rounded-lg border-gray-200 bg-white px-5 py-2.5 text-gray-700 focus:border-blue-400 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-40 dark:border-gray-600 dark:bg-gray-900 dark:text-gray-300 dark:focus:border-blue-300"
            />

            <Button bgColor="bg-blue-600" color="text-white" content={"Post"} />
          </div>

          <div className="flex flex-col gap-4 mt-8">
            {post &&
              post.comments.map((comment) => (
                <div className="flex justify-left gap-4 items-center p-4">
                  <img
                    className="hidden object-cover w-10 h-10 mx-4 rounded-full sm:block"
                    src={getUserImage(comment.user.profile_pic)}
                    alt="avatar"
                  />
